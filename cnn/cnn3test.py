...
list_of_files = glob.glob('C:/Users/roysi/Documents/programs/network-security-new/results/cnn3/*.hdf5')
latest_file = max(list_of_files, key=os.path.getctime)
cnn.load_weights(latest_file)

y_pred = cnn.predict_classes(X_test)

np.savetxt('res/expectedcnn3.txt', y_test1, fmt='%01d')
np.savetxt('res/predictedcnn3.txt', y_pred, fmt='%01d')
cnn.compile(loss='binary_crossentropy',optimizer='adam',metrics=['accuracy'])
